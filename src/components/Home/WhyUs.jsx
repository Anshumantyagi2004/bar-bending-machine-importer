...
export default function WhyChoose() {
  ...
  return (
    <section className="py-6 md:py-10 px-4 md:px-15 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 text-center sm:text-left place-items-center md:place-items-start">
          {features.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group bg-gray-50 p-6 rounded-2xl border border-gray-200 hover:shadow-xl transition duration-300 w-full max-w-sm"
              >
                {/* ICON */}
                <div
                  className={`w-14 h-14 flex items-center justify-center rounded-xl mb-4 mx-auto sm:mx-0 
